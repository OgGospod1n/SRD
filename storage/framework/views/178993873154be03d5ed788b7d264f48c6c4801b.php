...
<?php $component = $__env->getContainer()->make(Illuminate\View\AnonymousComponent::class, ['view' => 'jetstream::components.application-mark','data' => ['class' => 'block h-9 w-auto float-left']]); ?>
...
<?php endif; ?>
            ...
            <div class="hidden sm:flex text-gray-600 mt-2 hover:text-black transition-all sm:w-7/12 w-5/12" style="position: relative">
                ...
                <form method="GET" action="<?php echo e(route('search')); ?>" class="w-full">
...
<?php endif; ?>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
         ...
         <div class="text-gray-600 hover:text-black transition-all w-full px-4 mb-5" style="position: relative">
                ...
                <input type="search" name="search" placeholder="" autocomplete="off" id="search"
                    class="w-full transition duration-300 hover:bg-white hover:border-solid hover:shadow bg-gray-100 h-12 px-5 pl-12 rounded-lg text-md focus:outline-none"
                >
            </div>
            <?php endif; ?>
            <div class="flex items-center px-4">
                <div class="flex-shrink-0">
                    <img class="h-10 w-10 rounded-full" src="<?php echo e(Auth::user()->profile_photo_url); ?>"
                        alt="<?php echo e(Auth::user()->name); ?>" />
                </div>
...
<?php /**PATH C:\collaborative-document-editor-development\server\resources\views/navigation-dropdown.blade.php ENDPATH**/ ?>