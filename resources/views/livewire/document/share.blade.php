<div class="float-left w-full mb-10">
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
        ...
        <x-jet-form-section submit="share">
            <x-slot name="title">
                {{ $document->name }} установите общий доступ к файлу
            </x-slot>
        
            <x-slot name="description">
                Введите адрес электронной почты пользователя, которым вы хотите поделиться.
            </x-slot>
            ...
            <x-slot name="form">
                ...
                <div class="col-span-6 sm:col-span-4">
                    <span class="font-semibold">Пользователи документа:</span> 
                    <ul>
            ...
            <x-slot name="actions">
                ...
                <x-jet-button>
                    Предоставить разрешение на совместное использование
                </x-jet-button>
            </x-slot>
        </x-jet-form-section>
